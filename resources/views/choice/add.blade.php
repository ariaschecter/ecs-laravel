    ...
    <div class="col-lg-6">
        <form method="POST" action="{{ url('list_mapel/add') }}">
            ...
            <div>
                ...
                <input type="number" id="list_mapel_no" name="list_mapel_no" class="form-control @error('list_mapel_no') is-invalid @enderror" value="{{ old('list_mapel_no') }}" placeholder="List Mapel No">
            </div>
            ...
            <div class="mt-2">
                ...
                <input type="text" id="list_mapel_name" name="list_mapel_name" class="form-control @error('list_mapel_name') is-invalid @enderror" value="{{ old('list_mapel_name') }}" placeholder="List Mapel Name">
            </div>
            ...
            <div class="mt-2">
                ...
                <input type="text" id="list_mapel_link" name="list_mapel_link" class="form-control @error('list_mapel_link') is-invalid @enderror" value="{{ old('list_mapel_link') }}" placeholder="List Mapel Link">
            </div>
            ...
            <div class="mt-2">
                ...
                <textarea class="form-control @error('list_mapel_desc') is-invalid @enderror" id="list_mapel_desc" name="list_mapel_desc" rows="10"></textarea>
            </div>
