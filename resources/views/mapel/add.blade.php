...
<div class="row">
    <div class="col-lg-6">
        <form method="POST" action="{{ url('mapel/add') }}" enctype="multipart/form-data">
            @csrf
            <div>
                <label for="mapel_name" class="form-label">Mapel Name</label>
                <input type="text" id="mapel_name" name="mapel_name" class="form-control @error('mapel_name') is-invalid @enderror" value="{{ old('mapel_name') }}" placeholder="Mapel Name">
            </div>
            @error('mapel_name') <div class="text-danger">{{ $message }}</div> @enderror

            <div class="mt-2">
                <label for="semester_id" class="form-label">Semester</label>
                <input type="number" id="semester_id" name="semester_id" class="form-control @error('semester_id') is-invalid @enderror" value="{{ old('semester_id') }}" placeholder="Semester">
            </div>
            ...
            <div class="mt-2">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="mapel_active" name="mapel_active" value="1">
