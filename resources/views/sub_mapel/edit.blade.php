...
<div class="row">
    <div class="col-lg-6">
        <form method="POST" action="{{ url('sub_mapel/edit/' . $sub_mapel->sub_mapel_id) }}">
            @csrf
            <div class="mt-2">
                <label for="mapel_id" class="form-label">Select Mapel</label>
                <select class="form-select" id="mapel_id" name="mapel_id">
                    <option value="{{ $sub_mapel->mapel_id }}">{{ $sub_mapel->mapel->mapel_name }}</option>
            ...
            <div>
                ...
                <input type="number" id="sub_mapel_no" name="sub_mapel_no" class="form-control @error('sub_mapel_no') is-invalid @enderror" value="{{ $sub_mapel->sub_mapel_no }}" placeholder="Sub Mapel No">
            </div>
            ...
            <div class="mt-2">
                ...
                <input type="text" id="sub_mapel_name" name="sub_mapel_name" class="form-control @error('sub_mapel_name') is-invalid @enderror" value="{{ $sub_mapel->sub_mapel_name }}" placeholder="Sub Mapel Name">
            </div>
