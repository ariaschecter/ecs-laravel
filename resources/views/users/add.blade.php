    ...
    <div class="col-lg-6">
        <form method="POST" action="{{ url('user/add') }}">
            ...
            <div>
                ...
                <input type="text" id="user_name" name="user_name" class="form-control @error('user_name') is-invalid @enderror" value="{{ old('user_name') }}" placeholder="Full Name">
            </div>
            ...
            <div class="mt-2">
                ...
                <input type="text" id="user_city" name="user_city" class="form-control @error('user_city') is-invalid @enderror" value="{{ old('user_city') }}" placeholder="Kabupaten/Kota">
            </div>
            @error('user_city') <div class="text-danger">{{ $message }}</div> @enderror

            <div class="mt-2">
                <label for="user_age" class="form-label">Age</label>
                <input type="number" id="user_age" name="user_age" class="form-control @error('user_age') is-invalid @enderror" value="{{ old('user_age') }}" placeholder="Umur">
            </div>
